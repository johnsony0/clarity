export const youtubeSettings = {
  ...
  Navigation: [
    { id: 'yt-search-toggle', label: 'Hide Searchbar', type: 'checkbox', default: true, rating: 2, tag: 'search' },
    { id: 'yt-home-toggle', label: 'Hide Home Button', type: 'checkbox', default: true, rating: 2 },
    { id: 'yt-profile-toggle', label: 'Hide Your Stuff', type: 'checkbox', default: true, rating: 4 },
    { id: 'yt-subscriptions-toggle', label: 'Hide Subscriptions', type: 'checkbox', default: true, rating: 4 },
    { id: 'yt-explore-toggle', label: 'Hide Explore Button', type: 'checkbox', default: true, rating: 2 },
    { id: 'yt-morefrom-toggle', label: 'Hide More From YouTube', type: 'checkbox', default: true, rating: 2 },
  ...
  Posts: [
    ...
    { id: 'yt-mixes-toggle', label: 'Hide Music Mixes', type: 'checkbox', default: true, rating: 3 },
    { id: 'yt-reacts-toggle', label: 'Hide Reacts', type: 'checkbox', default: true, rating: 3 },
    { id: 'yt-comments-toggle', label: 'Hide Comments', type: 'checkbox', default: true, rating: 3 },
