export const twitterSettings = {
  ...
  Navigation: [
    ...
    { id: 'x-verifiedorgs-toggle', label: 'Hide Verified Orgs Button', type: 'checkbox', default: true, rating: 2 },
  ],
  Posts: [
  ...
  Home: [
    { id: 'x-homeposts-toggle', label: 'Hide Home Posts', type: 'checkbox', default: false, rating: 5 },
  ...
  Pages: [
    { id: 'x-pagesposts-toggle', label: 'Hide User Posts', type: 'checkbox', default: false, rating: 5 },
    ...
    { id: 'x-suggestions-toggle', label: 'Hide Follow Suggestions', type: 'checkbox', default: true, rating: 3 },
  ],
  Explore: [
